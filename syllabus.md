...
<table id="schedule" class="table table-bordered no-more-tables" style="width: 100%; font-size: 0.8em;">
    ...
    <tbody>
        <tr>
            ...
            <td> 09/15 </td>
            <td>
                <strong>Topics:</strong> <a href="/fall2020/lecture1.pdf">(slides)</a>
                <ul>
        ...
        <tr>
            ...
            <td>
                <strong>Quizzes (due at 8 30am PST):</strong>
                <ul>
                    <li>Introduction to deep learning</li>
                    <li>Neural Networks Basics</li>
                </ul>
                <strong>Programming Assignments (due at 8 30am PST)</strong>
                <ul>
